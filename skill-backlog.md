...
| 日期 | 模式 | 证据记录 | 建议动作 | 状态 |
| --- | --- | --- | --- | --- |
| 2026-05-10 | 多个浏览器爬虫脚本重复维护登录态，希望统一管理 cookie / session / profile | `AI工作记录/records/2026/05/2026-05-10-讨论-浏览器登录态全局skill设计.md` | 已新增 `browser-session-manager` 初版骨架，后续按真实站点补充校验与刷新流程 | 已实现初版 |
